...
**Drivers:** decoupled layers, testable services, fast agent integration
**Constraints:** no domain I/O, storage uses ledgercore primitives, bounded CLI filesystem use
**Related ADRs:** adr-0046, adr-0047, adr-0048, adr-0049, adr-0050, adr-0051
...
**Constraints:** ledgercore atomic primitives, fsync overhead, TASKLEDGER_TEST_FAST_IO escape hatch
