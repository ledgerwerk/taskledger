...
TASKLEDGER_STORAGE_LAYOUT_VERSION = 5
...
EXIT_CODE_EXTERNAL_FAILURE = 5
EXIT_CODE_UNAVAILABLE = EXIT_CODE_WORKFLOW_REJECTION
EXIT_CODE_CONFLICT = EXIT_CODE_LOCK_CONFLICT
# Compatibility names retain their public meaning while using the canonical
# Ledgerwerk family. Native Taskledger failures must never emit 6 or 7.
EXIT_CODE_MISSING = EXIT_CODE_UNAVAILABLE
EXIT_CODE_DATA_INTEGRITY = EXIT_CODE_CONFLICT
EXIT_CODE_STORAGE_ERROR = EXIT_CODE_CONFLICT
EXIT_CODE_VALIDATION_FAILED = EXIT_CODE_GENERIC_FAILURE
