...
def _render_plan_template(
    ...
    *,
    ...
    lines = [
        ...
        "## Summary",
        "",
        "<2-5 sentences describing the outcome, rationale, and boundaries>",
        "",
        "## Implementation Changes",
        "",
        "- <specific code/config/docs change>",
        "- <specific code/config/docs change>",
        "",
        "## Tests",
        "",
        "- <test command or regression case>",
        "- <manual verification, if needed>",
        "",
        "## Assumptions",
        "",
        "- <assumption the approver should accept>",
        "",
        "## Out of Scope",
        "",
